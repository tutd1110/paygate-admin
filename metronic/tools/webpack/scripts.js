...
window.NDBase = require("../../src/assets/js/pages/NDBase");
window.NDNotification = require("../../src/assets/js/global/NDNotification");
window.MyProfile = require("../../src/assets/js/global/MyProfile");
...
window.MyAdmin = require("../../src/assets/js/global/MyAdmin");
