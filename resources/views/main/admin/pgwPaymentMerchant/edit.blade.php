            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="{{ route('pgw_payment_merchant.index') }}" class="kt-subheader__breadcrumbs-link">Danh sách
                            các cổng thanh toán </a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{ $item[0]['name'] }}</a>
                    ...
                    <div class="kt-grid kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3 kt-wizard-v3__wrapper">
                            <form class="px-5 py-3 kt-form kt-form--label-right" id="formClass" method="post"
                                action="{{ route('pgw_payment_merchant.update', $item[0]['id']) }}"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" id="item-id" name="id"
                                    value="{{ $item[0] ? $item[0]['id'] : 0 }}">
