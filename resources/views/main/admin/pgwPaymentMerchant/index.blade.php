            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link">Danh sách các cổng thanh toán </a>
                    </div>
                </div>
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        <div class="btn-group">
                            <a href="{{ route('pgw_payment_merchant.create') }}"
                ...
                <div class="kt-portlet__body">
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="item-list"
                        ...
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th><b>Mã cổng thanh toán</b></th>
                                <th><b>Tên cổng thanh toán</b></th>
                                <th><b>Ảnh</b></th>
                        ...
                        <tbody>
                            @foreach ($listPaymentMerchant as $item)
                                <tr>
                                    <td style="text-align: center">{!! $item['id'] !!}</td>
                                    <td style="text-align: left;">{!! $item['code'] !!}</td>
                                    <td style="text-align: left">{!! $item['name'] !!} </td>
                                    <td style="text-align: left"><img src="{!! asset($item['thumb_path']) !!}" alt=""
                                            style="max-width: 16rem;display: block;margin: 0 auto;max-height: 10rem;"> </td>
                                    ...
                                    <td width="12%" style="text-align: center">
                                        <a href="{!! route('pgw_payment_merchant.edit', $item['id']) !!}" title="Sửa" style="padding:10px">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form id="delete-form-{{ $item['id'] }}"
                                            action="{{ route('pgw_payment_merchant.destroy', $item['id']) }}" method="post"
