            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="{{ route('pgw_listbanking.index') }}" class="kt-subheader__breadcrumbs-link">Danh sách ngân hàng </a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="javascript:" class="kt-subheader__breadcrumbs-link">Thêm mới ngân hàng </a>
                    </div>
                </div>
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        <a href="{{ route('pgw_listbanking.index') }}" class="btn btn-clean kt-margin-r-10">
                    ...
                    <div class="kt-grid kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3 kt-wizard-v3__wrapper">
                            <form class="px-5 py-3 kt-form kt-form--label-right" id="formProgram" method="post"
                                  action="{{ route('pgw_listbanking.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="kt-wizard-v3__content" data-ktwizard-type="step-content"
                                     data-ktwizard-state="current">
                                    @include('main.admin.pgwListBanking.components.item-general', [
                                        'item' => [],
                                    ])
                                </div>
                            </form>
