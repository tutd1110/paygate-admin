            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="{{ route('template_messages.index') }}" class="kt-subheader__breadcrumbs-link">Danh
                            sách SMS Template</a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="kt-grid kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3 kt-wizard-v3__wrapper">
                            <form class="px-5 py-3 kt-form kt-form--label-right" id="updateSMSTemplate"
                                  action="{{route('template_messages.update',$templateMessages['id'])}}"
                                  method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="kt-wizard-v3__content" data-ktwizard-type="step-content"
                                     data-ktwizard-state="current">
                                    @include('main.admin.template-messages.components.item-general',[
