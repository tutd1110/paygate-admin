                ...
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="{{ route('sys_group.index') }}" class="kt-subheader__breadcrumbs-link">Danh sách nhóm
                            quyềnngười dùng </a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{ $listGroup['name'] }}</a>
                    ...
                    <div class="kt-grid kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3 kt-wizard-v3__wrapper">
                            <form class="px-5 py-3 kt-form kt-form--label-right" id="formClass" method="post"
                                  action="{{ route('sys_group.update', $listGroup['id']) }}"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $.each($(".list_modules_input"), function () {
            const isChecked = $(this).prop('checked');
            if (isChecked) {
                $('#list_permission_' + $(this).val()).show();
            }
        });
