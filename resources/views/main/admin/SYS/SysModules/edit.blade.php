        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Danh sách Modules </h3>
                ...
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        <a href="{{ route('sys_modules.index') }}" class="btn btn-clean kt-margin-r-10">
                    ...
                    <div class="kt-grid kt-wizard-v3--white" id="kt_wizard_v3" data-ktwizard-state="step-first">
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3 kt-wizard-v3__wrapper">
                            <form class="px-5 py-3 kt-form kt-form--label-right" id="formClass" method="post"
                                  action="{{ route('sys_modules.update', $getListModules['id']) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="item-name">Tên Modules:</label>
                                                <input type="text" id="item-module" name="module"
                                                       class="form-control col-md-10 js-input-blur " value="{{ $getListModules['module'] }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="item-name">Modules_Alias:</label>
                                                <input type="text" id="item-module_alias" name="module_alias" class="form-control col-md-10 js-input-blur"
                                                       value="{{ old('module_alias', isset($getListModules['module_alias']) ? $getListModules['module_alias'] : '') }}"
