...
@section('script')
    ...
    <script type="text/javascript">
        ...
        select.addEventListener("change", (e) => {
            var getOption = $("#partner_code option:selected").text();
            document.getElementById("item-partner_code").value = getOption;
        });
        var payment_merchant = document.querySelector("#payment_merchant");
